...
export default function VegetableGlue() {
  ...
  return (
    <section className="relative bg-[#04012A] overflow-hidden md:flex h-[550px] sm:h-[550px] md:h-[700px] w-full">
      ...
      {/* Notch Thingy */}
      <div ref={ref_WhatWeDo} className={`absolute z-20 md:left-[50%] lg:left-[55%] xl:left-[60%] top-1/2 w-1/3 transition-all ease-in-out duration-[1500ms] ${is_visible_WWD ? "translate-x-0 scale-100" : "-translate-x-[40%] scale-110"}`}>
