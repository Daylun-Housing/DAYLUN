    ...
    <section className="relative bg-[var(--light-blue)] flex-col md:flex-row flex overflow-hidden h-[550px] sm:h-[550px] md:h-[700px] w-full">
      ...
      >
        <div className={`max-w-xl mt-16 text-left text-[var(--txt-bright)] px-5`}>
          ...
          <a href="./Investors">
            <button className="bg-[var(--light-blue)] mt-4 hover:bg-[var(--hover-med-blue)] md:bg-[var(--dark-blue)] text-[var(--txt-bright)] font-bold px-8 py-3 rounded-md scale-[70%] sm:scale-[75%] md:scale-[80%] lg:scale-100 hover:text-[var(--txt-faint-grey)] md:hover:bg-[var(--hover-dark-blue)] transition">
              MAKE IT REALITY
            </button>
          </a>
        </div>
