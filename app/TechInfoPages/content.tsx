...
Determined to find a better solution, Arthur spearheaded the development of an organic adhesive. The result was a vegetable-based glue that not only matched the strength of traditional epoxy but also eliminated harmful fumes and chemicals. Embracing this innovation, Daylun has since expanded the application of our vegetable glue beyond fashion accessories to the housing construction industry, offering a sustainable alternative for builders aiming to reduce chemical use and enhance environmental friendliness in their projects.`,
            ...
            }, 
            {
                ...
                contentArr: [
                    {
                        id: "pd-1",
                        paragraph: `Daylun brings innovative solutions right to your driveway, utilizing our unique vegetable glue to pave the way for a greener, more sustainable future. Our permeable driveway systems are designed not only to enhance your property but also to contribute to the ecological health of your community.`
                    },
                    {
                        id: "pd-2",
                        first: "Environmental Impact:",
                        first_quality: "font-bold",
                        paragraph: `By allowing water to penetrate through the surface, our driveways help reduce the load on city sewer systems and mitigate the risk of flooding. This makes the Daylun driveway an integral part of your home's green infrastructure, helping to absorb rainwater where it falls.`
                    },
                    {
                        id: "pd-3",
                        first: "Space Efficiency and Utility:",
                        first_quality: "font-bold",
                        paragraph: `The need for more housing on existing lots creates a challenge in balancing hard and green spaces. Our permeable driveway allows for this balance, providing ample hard space that supports additional construction without sacrificing environmental benefits. This means more room to build and less water runoff, keeping your property neat and more functional.`
                    },
                    {
                        id: "pd-4",
                        first: "Superior Strength and Durability:",
                        first_quality: "font-bold",
                        paragraph: `With a compressive strength of 15 MPa, our vegetable glue-based system significantly outperforms traditional asphalt, which typically measures around 2 MPa. The elastic properties of our glue ensure that the driveway remains resilient against cracking and weathering, maintaining its integrity and appearance over time.`
                    },
                    {
                        id: "pd-5",
                        first: "Simple and Sustainable Application:",
                        first_quality: "font-bold",
                        paragraph: `Installation of our permeable driveway is straightforward—mix pebbles with our vegetable glue, tamp down a layer of 100-150mm, and achieve a durable surface with a minimal carbon footprint. A small team of two to three people can efficiently handle the installation, making this an eco-friendly choice for residential projects.`
                    },
                    {
                        id: "pd-6",
                        paragraph: `Choose the Daylun permeable driveway to make your home a model of sustainability and practicality, prepared for the future while caring for the planet today.`
                    }
                ],
                cols: 0,
                imgs: [],
            ...
            }, 
            {
                ...
                contentArr: [
                    {
                        id: "iwh-1",
                        paragraph: `In today's environmentally conscious world, Daylun's permeable roadway system represents a breakthrough in sustainable infrastructure. Designed using our proprietary vegetable glue, this system not only supports durable and flexible road surfaces but also plays a crucial role in water conservation and management strategies.`
                    },
                    {
                        id: "iwh-2",
                        first: "Efficient Water Harvesting:",
                        first_quality: "font-bold",
                        paragraph: `Our permeable roads capture rainwater that would otherwise run off impervious surfaces, reducing water wastage. Strategically placed pipes beneath the road surface collect and channel this water, turning everyday rainfall into a valuable resource.`
                    },
                    {
                        id: "iwh-3",
                        first: "Enhanced Irrigation Capabilities:",
                        first_quality: "font-bold",
                        paragraph: `The harvested water can be directed to nearby fields, gardens, or urban green spaces, providing a reliable water source for irrigation. This system is particularly beneficial in areas facing water scarcity and restrictions, ensuring that natural resources are utilized efficiently.`
                    },
                    {
                        id: "iwh-4",
                        first: "Protection Against Water Damage:",
                        first_quality: "font-bold",
                        paragraph: `By managing where rainwater flows, our roadway system prevents erosion and protects infrastructural elements like house foundations from water damage. This proactive water management also mitigates the impact of heavy rainfall, enhancing the longevity of both the road surface and surrounding properties.`
                    },
                    {
                        id: "iwh-5",
                        first: "Sustainability and Future Readiness:",
                        first_quality: "font-bold",
                        paragraph: `With the increasing impact of climate change on water resources, our permeable roadway system is more than just an infrastructure solution; it is a step towards a sustainable future. This product reduces the ecological footprint of road construction and maintenance, aligning with global sustainability goals.`
                    },
                    {
                        id: "iwh-6",
                        paragraph: `Choose Daylun's permeable roadway system for your next project and invest in a solution that offers durability, ecological benefits, and a proactive approach to water management.`
                    }
                ]
            },
            {
            ...
            },
            {
                ...
                contentArr: [
                    ...
                    {
                        id: "NPS-4",
                        paragraph: `This innovation not only significantly reduces the carbon footprint associated with traditional construction methods but also leverages the versatility and environmental benefits of our Vegetable Glue. Join us as we continue to pioneer new ways to build more sustainable and resilient homes, one foundation at a time.`
                    }
                ]
            },
            {
                ...
                contentArr: [
                    {
                        id: "NPS-01",
                        paragraph: `At Daylun, we are committed to pioneering sustainable solutions in the construction industry. Our latest innovation harnesses the potential of recycled plastics, transforming them into durable building materials with the help of our environmentally friendly vegetable glue.`
                    },
                    {
                        id: "NPS-02",
            ...
            },
            {
                ...
                contentArr: [
                    {
                        id: "W-1",
                        paragraph: `Daylun, innovation and sustainability are at the core of our mission. Building on the success of our vegetable glue in the construction industry, we are excited to introduce its latest application as an eco-friendly exterior waterproofing product.`
                    },
                    {
                        id: "W-2",
                        first: "Eco-Friendly Waterproofing:",
                        first_quality: "font-bold",
                        paragraph: `Traditional waterproofing materials are often laden with harsh chemicals that can be harmful to both the environment and your health. Daylun's vegetable glue is formulated from organic, non-toxic components, making it a safe and sustainable choice for protecting your home against water damage.`
                    },
                    {
                        id: "W-3",
                        first: "Superior Protection:",
                        first_quality: "font-bold",
                        paragraph: `Engineered to provide a robust barrier against moisture, our vegetable glue waterproofing solution ensures that your home remains dry and well-protected from the elements. Its organic composition does not compromise on performance, offering superior adhesion and durability comparable to traditional methods.`
                    },
                    {
                        id: "W-4",
                        first: "Health and Safety:",
                        first_quality: "font-bold",
                        paragraph: `With Daylun's vegetable glue, safeguard your living space from the risks associated with chemical toxicity found in conventional waterproofing products. Our solution contributes to a healthier indoor air quality, making your home safer for families, especially those with children and pets.`
                    }
                ]
            },
            {
