      ...
      <div className="bg-[#04012A]">
        <div className="text-[28px] text-white px-[25px] py-[100px] whitespace-pre-wrap">
          ...
          <p>
            ...
            text for your whole article or post. We’ll put in some lorem ipsum
          ...
          <p>
            ...
            Basset hound. Zürich sleepy perfect consectetur. Body text for your
            whole article or post. We’ll put in some lorem ipsum to show how a
