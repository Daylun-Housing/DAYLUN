...
export default function PastReports() {
  ...
  return (
    <section className="relative overflow-hidden flex md:flex h-[300px] sm:h-[450px] sm:h-[550px] md:h-[700px] w-full">
      ...
      {/* Right Panel */}
      <div ref={ref_WhatWeDo} className={`relative w-1/2 md:w-2/3 h-full md:h-auto z-0 transition-all ease-in-out duration-1000 ${is_visible_WWD ? "translate-x-0 scale-100" : "-translate-x-[5%] scale-[140%]"}`}>
        <Image
