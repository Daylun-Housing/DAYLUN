...
export default function HowWeDo() {
  ...
  return (
    <section className="relative overflow-hidden md:flex h-[450px] sm:h-[550px] md:h-[700px] w-full">
      ...
      <div ref={ref_WhatWeDo} className={`relative w-full md:w-1/2 lg:w-2/3 h-[50%] md:h-auto z-0 transition-all ease-in-out duration-1000 ${is_visible_WWD ? "translate-x-0 scale-100" : "-translate-x-[5%] scale-[160%] lg:scale-[140%]"}`}>
          <Image
      ...
      <div ref={ref_WhatWeDo} className={`absolute left-[80%] sm:left-3/4 md:left-[55%] lg:left-2/3 top-1/2 w-1/3 transition-all ease-in-out duration-1000 ${is_visible_WWD ? "-translate-x-0 scale-100" : "translate-x-[35%] scale-110"}`}>
