export default function GetQuote() {
    return (
      <section className="bg-[#04012A] text-white py-20 px-6 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <button className="bg-[#0474BC] text-white font-semibold px-8 py-3 rounded-md hover:opacity-90 transition">
            GET A QUOTE TODAY
          </button>
        </div>
      </section>
