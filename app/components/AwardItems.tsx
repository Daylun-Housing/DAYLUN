    ...
    >
      <div className="flex w-1/2 justify-center">
        <div className="overflow-hidden w-full md:w-[40%] justify-center">
          <a
            href="https://techfest.london/2025/en/page/best-use-of-new-materials-in-a-project-2024"
          ...
          >
            <div className="flex duration-100 hover:scale-110 overflow-hidden w-full h-full justify-center [&>*:last-child]:hover:brightness-50">
              ...
              <div className="duration-100 relative items-center w-full h-full flex justify-center">
                <Image
                  src="/19-Tech-Winner.png"
                  alt="2024 Tech Winner"
                  fill
      ...
      <div className="flex w-1/2 justify-center">
        <div className="overflow-hidden w-full md:w-[40%] justify-center">
          <a
            href="https://techfest.london/2025/en/page/best-use-of-technology-design-efficiency-2024"
          ...
          >
            <div className="flex duration-100 hover:scale-110 w-full h-full justify-center [&>*:last-child]:hover:brightness-50">
              ...
              <div className="duration-100 relative items-center w-full h-full flex justify-center">
                <Image
                  src="/19-Tech-Final.png"
                  alt="2024 Tech Finalist"
                  fill
                  className="object-contain"
                />
              </div>
