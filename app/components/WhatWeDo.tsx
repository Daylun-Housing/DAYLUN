...
export default function WhatWeDo() {
  ...
  return (
    <section className="relative overflow-hidden md:flex h-[450px] bg-[#0474BC] sm:h-[550px] md:h-[700px] w-full">
      ...
      >
        <div className="bg-[#0474BC] text-white flex h-full flex-col justify-center py-5 px-3 md:px-20 relative ">
          <div className="max-w-md mt-4 md:mt-16">
            ...
            <a
              href="./About"
              className="text-[clamp(0.5rem, 0.5vw, 1.5rem)] md:text-[clamp(0.5rem,3vw,1.5rem)] mb-4 leading-relaxed hover:text-[#04012A]"
            >
      ...
      <div
        ref={ref_WhatWeDo}
        className={`relative w-full md:w-1/2 lg:w-2/3 h-full bg-[#04012A] md:h-auto z-0 transition-all ease-in-out duration-1000 ${is_visible_WWD ? "translate-x-0 scale-[102%]" : "-translate-x-[5%] scale-[140%] lg:scale-[125%]"}`}
      >
        <Image
          src="/what-we-do.jpg"
          alt="Modern house"
