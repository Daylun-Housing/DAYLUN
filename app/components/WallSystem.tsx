    ...
    <section className="relative bg-[#04012A] text-white py-24 md:px-4 overflow-hidden">
      ...
      <div className="relative flex justify-center items-end h-[700px] space-x-1 md:space-x-3 lg:space-x-4">
        ...
        <div className="relative w-[15%] h-full ml-16">
          <div ref={ref_WhatWeDo} className={`relative w-[80%] h-full transition-all ease-in-out duration-[1200ms] ${is_visible_WWD ? "translate-x-0 scale-[clamp(0.8,2vw,1.2)]" : "-translate-x-[300%]"}`}>
        ...
        <div className="relative w-[15%] h-full -ml-16">
          <div ref={ref_WhatWeDo} className={`relative w-[80%] h-full transition-all ease-in-out duration-[1400ms] ${is_visible_WWD ? "translate-x-0 scale-[clamp(0.8,2vw,1.2)]" : "-translate-x-[400%]"}`}>
            <Image src="/wall2.svg" alt="Wall 2" fill className="object-contain" />
          </div>
          <div ref={ref_WhatWeDo} className={`absolute bottom-20 md:bottom-0 left-1/2 -translate-x-1/2 text-white text-center leading-tight mb-2
        ...
        <div className="relative w-[15%] h-full -ml-16 -mr-16 z-10">
          <div ref={ref_WhatWeDo} className={`relative w-[80%] h-full transition-all ease-in-out duration-[1600ms] ${is_visible_WWD ? "translate-x-0 scale-[clamp(0.8,2vw,1.2)]" : "-translate-x-[500%]"}`}>
            <Image src="/wall3.svg" alt="Wall 3" fill className="object-contain" />
          </div>
          <div ref={ref_WhatWeDo} className={`absolute top-20 md:top-9 left-1/2 -translate-x-1/2 text-l text-white text-center
        ...
        <div className="relative w-[15%] h-full -mr-16">
          <div ref={ref_WhatWeDo} className={`relative w-[80%] h-full transition-all ease-in-out duration-[1800ms] ${is_visible_WWD ? "translate-x-0 scale-[clamp(0.8,2vw,1.2)]" : "-translate-x-[600%]"}`}>
        ...
        <div className="relative w-[15%] h-full">
          <div ref={ref_WhatWeDo} className={`relative w-[80%] h-full transition-all ease-in-out duration-[2000ms] ${is_visible_WWD ? "translate-x-0 scale-[clamp(0.8,2vw,1.2)]" : "-translate-x-[700%]"}`}>
            <Image src="/wall5.svg" alt="Wall 5" fill className="object-contain" />
          </div>
          <div ref={ref_WhatWeDo} className={`absolute top-5 md:-top-5 left-1/2 -translate-x-1/2 text-l text-white text-center leading-tight
