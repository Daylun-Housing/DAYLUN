...
export default function Featured() {
  ...
  return (
      <section className="overflow-hidden relative md:flex h-[550px] md:h-[700px] w-full">
          {/* Left Panel */}
        <div ref={ref_WhatWeDo} className={`w-full md:w-1/3 transition-all ease-in-out duration-1000 
      ...
      {/* Right Panel */}
      <div ref={ref_WhatWeDo} className={`relative w-full md:w-2/3 h-full md:h-auto z-0 transition-all ease-in-out 
