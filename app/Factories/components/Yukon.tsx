...
export default function Yukon() {
  ...
  return (
    <section className="relative overflow-hidden flex h-[700px] w-full">
      {/* Left Panel */}
      <div ref={ref_WhatWeDo} className={`bg-[#04012A] w-1/3 transition-all ease-in-out duration-1000 
        ...
        <div className="text-white flex flex-col justify-center px-10 md:px-20 w-full h-full relative">
          <div className="max-w-md mt-16">
            <h2 className="z-20 text-3xl sm:text-4xl lg:text-4xl xl:text-6xl font-extrabold mb-8 leading-tight">
              Yukon Factory
            </h2>
      ...
      {/* Right Panel */}
      <div ref={ref_WhatWeDo} className={`relative w-2/3 h-full md:h-auto z-5 transition-all ease-in-out 
      ...
      <div className={`absolute w-full md:w-1/2 lg:w-[30%] translate-y-[450%] bg-[#04012A] text-xs z-10 m-4 transition-all ease-in-out duration-1000 
                                         `}>
          <div className="w-4/5">
            <Newsletter/>
