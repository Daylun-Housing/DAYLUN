...
export default function Bathroom() {
  ...
  return (
    <>
        <h1 className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl text-center mt-6 mb-4 font-bold">The <span className="text-[#0474BC]">Bathroom</span></h1>
                    
        <p className="mb-4 lg:mb-[50px]">Some of the highlights of the bathroom include: </p>
        <div className="flex-col">
          ...
          <div ref={ref_WhatWeDo} className={`md:flex w-full h-[400px] md:h-[125px] xl:h-[250px]
                                              transition-all duration-[1500ms] ease-in-out ${is_visible_WWD ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-[100px]"}
                                              `}>
