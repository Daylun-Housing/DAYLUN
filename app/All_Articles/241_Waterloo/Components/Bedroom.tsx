  ...
  return (
    <>
      <h1 className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl text-center mt-6 mb-4 font-bold">
        The <span className="text-[#0474BC]">Bedroom</span>
      </h1>

      <p className="mb-[50px]">
        Some of the highlights of the bedroom include:{" "}
      </p>
      <div className="flex-col">
        ...
        <div
          ref={ref_WhatWeDo}
          className={`flex flex-col md:flex-row w-full md:mt-10 mb-10 h-[300px] md:h-[250px] items-center md:justify-center
                                              transition-all duration-[1500ms] ease-in-out ${is_visible_WWD ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-[100px]"}
                                              `}
        >
