          ...
          <div className='bg-[#04012A] flex-col'>
            <div className="text-sm md:text-md lg:text-xl text-white px-[5%] py-[100px] whitespace-pre-wrap">
              ...
              <div className="flex justify-center mt-5 py-[15px] w-full h-full object-cover">
                <Image src="/toronto-town-home.jpg" alt="bamboo OSB" width={500} height={75}/>
              </div>
              ...
              <div className="flex mt-4 text-xs md:text-sm lg:text-lg gap-4">
                <ul className="flex-col w-1/2 space-y-4">
                  ...
                  <li>- Engineered porcelain flooring for maximum Heat absorption</li>
                  ...
                  <li>- Lap pool</li>
                  <li>- Biophelic designed staircase with vegetation running from basement to top floor</li>
                </ul>
                <ul className="flex-col w-1/2 space-y-4">
                  ...
                  <li>- East and west walls have vertical blinds that change with season to reflect sun or absorb it</li>
                  <li>- On-demand electric water heaters</li>
                  <li>- Root cellar</li>
                  <li>- Front wall design detail acts as the “Brain” of the house that is easily accessible from outside for servicing</li>
                  <li>- Lifi technology for internet</li>
                  <li>- Concrete polished cement floor</li>
                  <li>- Skylights that shine down on glass floor hallway 2nd floor and main floor</li>
