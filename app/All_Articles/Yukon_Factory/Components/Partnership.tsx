...
export default function Partnership() {
  ...
  return (
    <>
        <h1 className="text-6xl text-center mt-6 mb-20 font-bold">Looking for <span className="text-[#0474BC]">Partners</span></h1>

        <div className="flex-col">
          <div className="w-full mb-20">
              
              <p className="flex-col text-lg space-y-4 m-5 w-full">
              ...
              <a href="mailto:info@daylun.ca">
                <h3 className="m-5 hover:brightness-[70%]">
                  <span className="text-[#0474BC] font-bold ">CONNECT</span> with us if you are interested!
                </h3>
