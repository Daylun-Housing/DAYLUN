  ...
  return (
    <>
      <h1 className="text-4xl md:text-5xl lg:text-7xl xl:text-8xl text-center mt-6 mb-5 md:mb-20 font-bold">
        Looking for <span className="text-[#0474BC]">Partners</span>
      </h1>
      ...
      <div className="flex-col">
        <div className="w-full mb-20">
          <p className="flex-col text-sm md:text-md lg:text-xl space-y-4 m-5 w-full px-[5%]">
            ...
            projects. We are looking to collaborate to revolutionize the
            construction industry by ensuring that projects are both sustainable
            and affordable.
          </p>
