  ...
  return (
    <>
      <h1 className="text-4xl md:text-5xl lg:text-7xl xl:text-8xl text-center mt-6 mb-5 md:mb-20 font-bold">
        Unique <span className="text-[#0474BC]">Features</span>
      </h1>

      <div className="flex-col">
        <div className="md:flex w-full mb-20">
          <p className="flex-col text-sm md:text-md lg:text-xl space-y-4 ml-10 mr-10 md:w-1/2">
            By combining our automated technology and our strategic processes,
            our Yukon Factory will be highly efficient and require limited human
            labour. This will helps us reduce costs, thereby maintaining high
            profit margins while also ensuring that our product remains
            affordable.
          </p>
