      ...
      <div className="bg-[#04012A] w-full">
        <div className="text-sm md:text-md lg:text-xl text-white px-[5%] py-[10px] whitespace-pre-wrap">
          <p className="first-letter:text-5xl">
            DAYLUN is proud to announce its latest product - Daylun's Exterior
            OSB Sheathing. Made from sustainable materials, this OSB is both
          ...
          <ul>
            ...
            <li className="flex gap-x-4">
              <Image
                ...
                className="object-contain"
              />
              <b>Upcyclable</b> - bamboo from old OSB can be reused in new
              products.
            </li>
            <br />
            <li className="flex gap-x-4">
          ...
          <p className="font-bold">
            Currently retailing for $95 per 4' x 8' sheet.
          </p>
          ...
          <p>
            ...
            <a
              href="https://daylun.myshopify.com/products/spec-sheet"
              className="hover:brightness-75"
            >
              Or purchase our
              <span className="mx-2 text-[#0474BC]">product</span>
              today!
            </a>
          </p>
        </div>
