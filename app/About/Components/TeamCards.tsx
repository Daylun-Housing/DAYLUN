...
export default function TeamCards() {
  return (
    <section className="bg-[#04012A] text-white py-16 px-6 md:px-20">
      <h2 className="text-4xl font-extrabold mb-10 text-center">Our Leadership Team</h2>
      <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-3">
        {team.map((person, idx) => (
          <div key={idx} className="bg-[#0A083D] rounded-xl shadow-lg p-6 flex flex-col items-center text-center">
            ...
            <a href={person.linkedin} target="_blank" rel="noopener noreferrer" className="mt-4 text-[#0474BC] hover:text-[#0f99e0]">
