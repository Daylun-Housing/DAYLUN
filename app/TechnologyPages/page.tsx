...
function Fallback() {
  return (
      <StdLayout>
        <div className="p-6 text-blue-600 h-screen">
 ...
 * PAGE
 * @returns {JSX.Element}
 * Translating configuration into a page. 
 */
export default function Page() {
    ...
    /**
     * HANDLE BUTTON PRESS IMPACT
     *  Add Impact text when pressed or remove. 
     */
    ...
    /**
     * HANDLE BUTTON PRESS WHY
     *  Add Why text when pressed or remove. 
     */
    ...
    /**
     * HANDLE BUTTON PRESS FEATURES
     *  Add Feature text when pressed or remove. 
     */
  ...
  return (
    <StdLayout>
        {/*Header*/}
          <div className="bg-[var(--dark-blue)] text-[var(--txt-bright)] flex flex-col relative z-10 ">
            <div className="relative w-full h-full flex flex-col md:flex-row items-center justify-center">
              ...
              <div className="relative w-full md:w-1/2 px-20">
                <h2 className="text-[clamp(2rem,4vw,6rem)] md:text-[clamp(1.5rem,4vw,3rem)] font-extrabold md:mb-8 leading-tight text-[var(--light-blue)]">{content.title}</h2>
                <p className="text-[clamp(0.75rem,1.5vw,1.25rem)]"><span className="font-bold">Price:</span> ${content.price} CAD</p>
                <br />
                
                <a href={content.link}>
                  <button className="bg-[var(--light-blue)] text-[var(--txt-bright)] font-bold px-8 py-3 hover:text-[var(--txt-faint-grey)] hover:bg-[var(--hover-med-blue)] transition w-full md:w-[60%]">
                    PURCHASE NOW
                  </button>
                </a>
                ...
                <br />
                <br />
                <h2 className="font-bold text-[clamp(1rem,3vw,2rem)] text-[var(--light-blue)]">Information</h2>
                <p>{content.description}</p>
                <br />
                <h2 className="font-bold text-[clamp(1rem,3vw,2rem)] text-[var(--light-blue)]">Specifications</h2>
                <p className="whitespace-pre-line">{content.specifications}</p>
                <br />
              </div>
            </div>
            <div className="bg-[var(--light-blue)] h-[10px]"></div>
            ...
            <div className="relative flex flex-col items-center p-10 transition">
              <h2 className="font-bold text-[clamp(1.2rem,3vw,2.5rem)] text-[var(--light-blue)] py-8">Sustainability</h2>
              <div className="gap-y-[5%] md:gap-x-[2%] flex flex-col md:flex-row h-[100vh] md:h-[75vh] w-full justify-center">

                {content.recyclable && <div className="relative w-full md:w-1/3 bg-[var(--less-dark-blue)] h-full flex flex-col">
                ...
                {content.upcyclable && <div className="relative w-full md:w-1/3 bg-[var(--less-dark-blue)] h-full flex flex-col">
                  <div className="relative w-full h-full md:h-4/5 flex justify-center">
                ...
                {content.biodegrable && <div className="relative w-full md:w-1/3 bg-[var(--less-dark-blue)] h-full flex flex-col">
                  <div className="relative w-full h-full md:h-4/5 flex justify-center">
