...
const Newsletter = () => {
  return (
    <form className="rounded px-8 pt-6 pb-8 mb-4 max-w-1/2">
      <div className="flex">
        <input
        ...
        />
        <button
          className="bg-[#0474BC] hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline disabled:bg-slate-400"
          type="submit"
        >
          Subscribe
        </button>
